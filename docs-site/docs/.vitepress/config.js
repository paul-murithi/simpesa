      ...
      sidebar: [
        {
          ...
          items: [
            ...
            { text: 'Future Enhancements', link: '/guide/future-enhancements.md' }
          ]
        },
        {
          text: 'Core Guides',
          items: [
            ...
            { text: 'Simulating Scenarios', link: '/guide/simulating-scenarios.md' },
            { text: 'Transition to Daraja', link: '/guide/transition-to-daraja.md' }
          ]
        },
        {
          text: 'Development',
